...
<nav class="bg-white border-b-4 border-purple-300 shadow-md">
    <div class="container mx-auto flex items-center justify-between px-6 py-3">
        ...
        <ul class="hidden md:flex items-center space-x-6 font-medium text-gray-700">
            <li><a href="/Dashboard" class="hover:text-green-700">Beranda</a></li>
            <li><a href="/Kelola-Sampah" class="text-white bg-green-700 px-5 py-2 rounded-lg hover:bg-green-800">Kelola Sampah</a></li>
